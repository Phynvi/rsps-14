...
import com.elvarg.world.entity.combat.method.impl.specials.BallistaCombatMethod;
...
public enum CombatSpecial {
	...
	BALLISTA(new int[]{ 19481 }, 65, 1.30, 1.0, new BallistaCombatMethod(), WeaponInterface.BALLISTA),
	;
