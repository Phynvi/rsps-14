...
public final class Projectile extends Renderable {
	...
	public Model getRotatedModel() {
		...
		if(frameNumber != -1) {
			projectileModel.method469();
			projectileModel.applyTransform(frameNumber);
			projectileModel.anIntArrayArray1658 = null;
			projectileModel.anIntArrayArray1657 = null;
		}
		if(projectileGFX.resizeXY != 128 || projectileGFX.resizeZ != 128) {
			projectileModel.method478(projectileGFX.resizeXY, projectileGFX.resizeXY, projectileGFX.resizeZ);
		}
		projectileModel.method474(tiltAngle);
		projectileModel.method479(64 + projectileGFX.modelBrightness, 850 + projectileGFX.modelShadow, -30, -50, -30, true);
